...
export const infectionDecisionSupport: Record<InfectionId, InfectionDecisionSupport> = {
  ...
  cellulitis: priority("①最優先：S. pyogenes、その他β溶血性レンサ球菌", "②背景で追加：MSSA", "③特殊背景・稀：咬傷・水曝露など曝露特異的病原体"),
  ...
  prostatitis: priority("①最優先：E. coli", "②背景で追加：Klebsiella、Proteus", "③特殊背景・稀：尿路操作後の緑膿菌、Enterococcus"),
